...
\begin{figure}[H]
    ...
    % First row of boxes
    \node[fill=green!30] (n1) {Bar};
    \node[fill=yellow!30, right=of n1] (n2) {Pos};
    \node[fill=blue!30,   right=of n2] (n3) {Tempo};
    \node[fill=red!30,    right=of n3] (n4) {Pitch};
    \node[fill=orange!30, right=of n4] (n5) {Vel.};
    \node[fill=green!30,  right=of n5] (n6) {Dur.};
