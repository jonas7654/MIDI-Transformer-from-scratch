...
if __name__ == '__main__':
    ...
    parser.add_argument('--tokenizer', type=str,
                                default='/home/jv/Documents/Universität Heidelberg/3. Semester/Introduction to Neural Networks/GoePT_current_state/models/tokenizers/goe_pt/goe_pt_tokenizer.json')
